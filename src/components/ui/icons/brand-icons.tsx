...
export const AppleIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 20 20" {...brandAccessibility(label)} {...props}>
      <path
        d={applePath}
        fill="currentColor"
      />
...
export const GoogleIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 20 20" {...brandAccessibility(label)} {...props}>
      <path fill="#4285F4" d="M19.6 10.227c0-.709-.064-1.39-.182-2.045H10v3.868h5.382A4.6 4.6 0 0 1 13.386 15.068v2.509h3.232c1.891-1.741 2.982-4.305 2.982-7.35Z" />
      <path fill="#34A853" d="M10 20c2.7 0 4.964-.896 6.618-2.423l-3.232-2.509c-.895.6-2.04.955-3.386.955-2.605 0-4.809-1.76-5.595-4.123H1.064v2.59A9.998 9.998 0 0 0 10 20Z" />
      <path fill="#FBBC05" d="M4.405 11.9A6.018 6.018 0 0 1 4.09 10c0-.659.114-1.3.314-1.9V5.51h-3.34A9.998 9.998 0 0 0 0 10c0 1.614.386 3.141 1.064 4.491l3.34-2.59Z" />
      <path fill="#EA4335" d="M10 3.977c1.468 0 2.786.505 3.823 1.496l2.868-2.868C14.959.99 12.696 0 10 0a9.998 9.998 0 0 0-8.936 5.51l3.34 2.59C5.191 5.736 7.396 3.977 10 3.977Z" />
    </svg>
  ),
);
...
export const FacebookIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 20 20" {...brandAccessibility(label)} {...props}>
      ...
      <path fill="#fff" d="M13.9 10.58h-2.48V19H7.65v-8.42H5.8V7.37h1.85V5.3c0-2.5 1.13-4.3 4.69-4.3.75 0 1.55.08 1.86.12v3.17h-1.57c-1.22 0-1.21.46-1.21 1.32v1.76h2.8l-.32 3.21Z" />
    </svg>
  ),
);
...
export const MastercardIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 32 20" {...brandAccessibility(label)} {...props}>
      ...
      <path fill="#FF5F00" d="M16 5.42A5.49 5.49 0 0 1 18.5 10a5.49 5.49 0 0 1-2.5 4.58A5.49 5.49 0 0 1 13.5 10 5.49 5.49 0 0 1 16 5.42Z" />
    </svg>
  ),
);
...
export const SaudiFlagIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 24 16" {...brandAccessibility(label)} {...props}>
      <rect width="24" height="16" rx="2" fill="#006C35" />
      <path fill="#fff" d="M5 11.5h14v1H5zm2.1-5.8h9.8v.9H7.1zm1.1 1.6h7.6v.8H8.2zm1.3 1.5h5v.8h-5z" />
      <path d="M18.4 10.2c-2.8 1-7.8 1-12.8 0" fill="none" stroke="#fff" strokeWidth=".7" strokeLinecap="round" />
    </svg>
  ),
);
...
export const MadaIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 32 20" {...brandAccessibility(label)} {...props}>
      ...
      <path fill="#fff" d="M4 6h3.2v8H4zM8.3 8h2.3v6H8.3zM11.7 5h2.4v9h-2.4zM15.2 7h2.6v7h-2.6zM19 6h2.5v8H19zM22.7 8h2.2v6h-2.2zM26 5h2v9h-2z" />
    </svg>
  ),
);
...
export const BankIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 24 24" fill="none" {...brandAccessibility(label)} {...props}>
      <path d="m3 9 9-5 9 5M5 10v7m4-7v7m6-7v7m4-7v7M3 20h18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
);
...
export const CashIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 24 24" fill="none" {...brandAccessibility(label)} {...props}>
      ...
      <path d="M7 9a2 2 0 0 1-2 2v2a2 2 0 0 1 2 2m10-6a2 2 0 0 0 2 2v2a2 2 0 0 0-2 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
...
export const TamaraIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ label, ...props }, ref) => (
    <svg ref={ref} viewBox="0 0 38 20" {...brandAccessibility(label)} {...props}>
      <rect width="38" height="20" rx="4" fill="#51C7A2" />
      <path fill="#fff" d="M5 6h8v2h-3v7H8V8H5zm10 2h2v7h-2zm4 0h2v1c.5-.8 1.2-1.2 2.2-1.2 1.1 0 1.9.5 2.3 1.3.6-.9 1.4-1.3 2.5-1.3 1.7 0 2.7 1.1 2.7 3V15h-2v-3.8c0-1-.5-1.6-1.3-1.6-.9 0-1.5.7-1.5 1.8V15h-2v-3.8c0-1-.5-1.6-1.3-1.6-.9 0-1.6.7-1.6 1.8V15h-2V8Zm13 0h2v1.2c.4-.8 1.1-1.3 2-1.3v2c-1.3 0-2 .7-2 2.2V15h-2V8Z" />
    </svg>
  ),
);
